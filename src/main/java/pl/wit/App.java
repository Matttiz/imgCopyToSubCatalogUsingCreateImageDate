 ...
 * Tworząc jednocześnie podfoldery w miejscu docelowym o nazwach dat kopiowanych plików
 *
 */
public class App 
{
    public static void main( String[] args ) throws IOException
    {
		...
		DestinationStructure destinationStructure = new DestinationStructure(
				new HashSet<String>(fileMapByFileExtension.values()), parameters.getDestinationPathToFolder(), extension);
		...
		for(String folder:destinationStructure.getNames()) {
			fold = parameters.getDestinationPathToFolder() +"/" + folder;
